...
-- AlterTable
ALTER TABLE `utilisateur` MODIFY `role` ENUM('SUPER_ADMIN', 'ADMIN', 'DIRECTION', 'LOCATAIRE', 'RESPONSABLE', 'TECHNICIEN') NOT NULL;

-- CreateTable
CREATE TABLE `LogActivite` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `utilisateurId` INTEGER NOT NULL,
    `typeAction` ENUM('CREATION', 'MODIFICATION', 'SUPPRESSION', 'VALIDATION', 'REJET', 'CONNEXION', 'DESACTIVATION', 'REACTIVATION', 'RESET_MOT_DE_PASSE') NOT NULL,
    `module` VARCHAR(50) NOT NULL,
    `description` TEXT NOT NULL,
    `entiteId` INTEGER NULL,
    `entiteType` VARCHAR(50) NULL,
